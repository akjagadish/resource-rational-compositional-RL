...
path = '/notebooks/modelfits/simulated_data_preds/optimal/simple_grammar/'
...
np.save('{}/regrets_simple_grammar_simulated_greedy_{}_{}_{}'.format(path, condition, rule, eps), regrets)
np.save('{}/actions_simple_grammar_simulated_greedy_{}_{}_{}'.format(path, condition, rule, eps), actions)